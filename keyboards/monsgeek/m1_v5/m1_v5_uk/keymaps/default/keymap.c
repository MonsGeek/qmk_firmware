...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* Base */
        ...
        _______,  _______,  HS_DIR,   KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,   KC_USB,   KC_INS,   _______,  KC_PSCR,  _______,  _______,            RGB_MOD,  
        _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  RGB_TOG,  _______,  _______, _______,  _______,  RGB_RMOD,
        _______,  _______,  _______,  _______,  KC_CALC,  _______,  _______,  _______,  KC_MUTE,  RGB_HUD,  RGB_HUI,  _______,  MO(_FBL), RGB_VAI,  _______,
        _______,  GU_TOGG,  _______,                     HS_BATQ,                                _______,  _______,  HS_CT_A,  RGB_SAD,  RGB_VAD,  RGB_SAI),
    ...
    [_MFL] = LAYOUT( /* Base */
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  RGB_TOG,  _______,  _______,  _______,  _______,  RGB_RMOD,
        _______,  _______,  _______,  _______,  KC_CALC,  _______,  _______,  _______,  KC_MUTE,  RGB_HUD,  RGB_HUI,  _______,  MO(_FBL), RGB_VAI,  _______,
        _______,  _______,  _______,                      HS_BATQ,                                _______,  _______,  HS_CT_A,  RGB_SAD,  RGB_VAD,  RGB_SAI),
    [_FBL] = LAYOUT( /* Base */ 
